@extends('users/layouts.balancesheetmaster')
...
<article class="content dashboard-page">
        <div class="title-block">
                ...
                <h3 class="title">Balance sheet account of farm</h3>
            ...
            <div class="col col-12 col-sm-12 col-md-6 col-xl-12 stats-col">
                        ...
                        <div class="card-header card-header-sm bordered">
                            <div class="header-block">
                                <h3 class="title"> {{Auth::user()->name}}'s farm, balance sheet account</h3>
                            </div>
...
{{-- 
    ...
    <p class="title-description"> Assets </p>  
    ...
    <div class="table-responsive">
        <table class="payrollTable table1 table-hover">
            ...
            <tbody>
                 @foreach ($getAllAssestsOfFarmFromJournal as $pen)  
                ...
                <tr>
                    ...
                    <td class="title-description"> Liability </td>
                    <td>   </td>
                    <td>  </td>
                 ...
                 @foreach ($getAllLiabilityOfFarmFromJournal as $pene) 
                                   
                <tr>
                   
                    <td> {{$pene->acc_name}} </td>
                    <td> {{ number_format($pene->SUMCREDIT, 2, ".", ",")}} </td>
                    <td> {{ number_format($pene->SUMDEBIT, 2, ".", ",")}} </td>
                ...
                <tr>
                    ...
                    <td class="title-description"> Equity </td>
                    <td>   </td>
                    <td>  </td>
                 ...
                 @foreach ($getAllEquityOfFarmFromJournal as $peneq) 
                                   
                <tr>
                   
                    <td> {{$peneq->acc_name}} </td>
                    <td> {{ number_format($peneq->SUMCREDIT, 2, ".", ",")}} </td>
                    <td> {{ number_format($peneq->SUMDEBIT, 2, ".", ",")}} </td>
