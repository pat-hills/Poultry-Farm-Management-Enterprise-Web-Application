@extends('users/layouts.journalmaster') 
@section('journal')
<article class="content forms-page">
    <div class="title-block">
        ...
        @endif -->
        <div class="title">
            <button type="button" class="btn btn-primary" id="btnadd" data-toggle="modal" data-target="#addEmployee">Add Journal</button>
        </div>
        <h3 class="title"> List of farm journals (Add Cr,Dr to your income acc, expense acc etc)</h3>
        ...
        <section class="section">
            <div class="col-md-12">
                <div class="modal-header">
                    <h4 class="modal-title" id="modelTitleId">ADD JOURNAL</h4>
                ...
                <div class="modal-content">
                    <div class="card card-block sameheight-item">
                        <form method="POST"  action="{{route('account.createjournals')}}">
                            {{csrf_field()}}
                            <div class="row form-group">
                                <div class="col-6">
                                    <div class="row">
                                        <label class="col-sm-4 form-control-label">Account name<label style="color: red;">*</label></label>
                                        <div class="col-sm-8">

                                                <select name="acc_name" class="form-control" required>
                                ...
                                <div class="col-6">
                                    <div class="row">
                                        <label class="col-sm-4 form-control-label">Description<label style="color: red;">*</label></label>
                                        <div class="col-sm-8">
                                            <textarea name="description	" autocomplete="off" required type="text" class="form-control" placeholder="Descrition of journal"></textarea>
                            ...
                            <div class="row form-group">
                                <div class="col-6">
                                    <div class="row">
                                        <label class="col-sm-4 form-control-label">DEBIT AMOUNT<label style="color: white;">*</label></label>
                                        <div class="col-sm-8">
                                                <input name="debit" autocomplete="off" required type="number" class="form-control" placeholder="0.00">
                                ...
                                <div class="col-6">
                                    <div class=" row">
                                                ...
                                                <label class="col-sm-4 form-control-label">CREDIT AMOUNT<label style="color: white;">*</label></label>
                                        <div class="col-sm-8">
                                                <input name="credit" autocomplete="off" required type="number" class="form-control" placeholder="0.00">
